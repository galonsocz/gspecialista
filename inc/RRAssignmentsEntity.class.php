...
class PluginGSpecialistARRAssignmentsEntity extends CommonDBTM {
    ...
    public function __construct() {
        ...
        $this->DB = $DB;
        $this->rrAssignmentTable = PluginGSpecialistAConfig::getRrAssignmentTable();
        $this->rrOptionsTable = PluginGSpecialistAConfig::getRrOptionsTable();
    }
...
EOT;
            ...
            PluginGSpecialistALogger::addWarning(__FUNCTION__ . " - table not dropped because it does not exist: " . $this->rrAssignmentTable);
        }
...
EOT;
            ...
            PluginGSpecialistALogger::addWarning(__FUNCTION__ . " - table not dropped because it does not exist: " . $this->rrOptionsTable);
        }
    }
